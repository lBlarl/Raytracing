...
//eigene Tests
TEST(VECTOR, LENGTH1) {
  Vector3df vector = {0.0, 3.0, 0.0};
  float vector_length = vector.length();

  EXPECT_NEAR(3.0, vector_length, 0.00001);
}
...
TEST(VECTOR, LENGTH2) {
  ...
  EXPECT_NEAR(0.0, vector_length, 0.00001);
}

TEST(VECTOR, SQUARE_LENGTH)
{
  Vector3df vector = {1.0, 2.0, 3.0};
  float vector_suare_length = vector.square_of_length();

  EXPECT_NEAR(14.0, vector_suare_length, 0.00001);
}

TEST(VECTOR, SCALAR_VECTOR_PRODUCT_TEST)
{
  Vector3df vector1 {2.0, 5.0, 3.0};
  Vector3df vector2 {3.0, 2.0, 1.0};
  float scalar = vector1 * vector2;

  EXPECT_NEAR(19.0, scalar, 0.00001);
}

TEST(VECTOR, SCALAR_VECTOR_PRODUCT_TEST2){
  Vector2df vector1 {4.0, 8.0};
  Vector2df vector2 {3.0, 4.0};
  float scalar = vector1 * vector2;

  EXPECT_NEAR(44.0, scalar, 0.00001);
}
